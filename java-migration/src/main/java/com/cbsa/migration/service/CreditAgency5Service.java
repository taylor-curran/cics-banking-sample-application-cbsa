...
@Service
public class CreditAgency5Service {

    private static final String AGENCY_ID = "CRDTAGY5";
    ...
    public CreditAgencyResponseDto getAgencyInfo() {
        CreditAgencyResponseDto response = new CreditAgencyResponseDto(true, "Credit Agency 5 Information");
        response.setAgencyId(AGENCY_ID);
