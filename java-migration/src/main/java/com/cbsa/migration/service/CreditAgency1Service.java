...
@Service
public class CreditAgency1Service {

    private static final String AGENCY_ID = "CRDTAGY1";
    ...
    public CreditAgencyResponseDto getAgencyInfo() {
        CreditAgencyResponseDto response = new CreditAgencyResponseDto(true, "Credit Agency 1 Information");
        response.setAgencyId(AGENCY_ID);
