...
@Service
public class CreditAgency3Service {

    private static final String AGENCY_ID = "CRDTAGY3";
    ...
    public CreditAgencyResponseDto getAgencyInfo() {
        CreditAgencyResponseDto response = new CreditAgencyResponseDto(true, "Credit Agency 3 Information");
        response.setAgencyId(AGENCY_ID);
