...
@Service
public class CreditAgency4Service {

    private static final String AGENCY_ID = "CRDTAGY4";
    ...
    public CreditAgencyResponseDto getAgencyInfo() {
        CreditAgencyResponseDto response = new CreditAgencyResponseDto(true, "Credit Agency 4 Information");
        response.setAgencyId(AGENCY_ID);
